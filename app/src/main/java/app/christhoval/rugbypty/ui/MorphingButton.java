package app.christhoval.rugbypty.ui;
...
import app.christhoval.rugbypty.ui.utils.MorphingAnimation;
import app.christhoval.rugbypty.ui.utils.StrokeGradientDrawable;
...
public class MorphingButton extends Button {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int cornerRadius = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_RADIUS_DIP, getResources().getDisplayMetrics());
        int color = Color.WHITE;
        int colorDark = Color.DKGRAY;

        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MorphingButton);
            color = a.getColor(R.styleable.MorphingButton_mb_color, color);
            colorDark = a.getColor(R.styleable.MorphingButton_mb_colorDark, colorDark);
            cornerRadius = (int) a.getDimension(R.styleable.MorphingButton_mb_cornerRadius, cornerRadius);
            a.recycle();
        }
