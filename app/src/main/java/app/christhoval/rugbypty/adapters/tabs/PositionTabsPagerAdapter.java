...
/**
 * Created by christhoval on 08/18/16.
 */
public class PositionTabsPagerAdapter extends FragmentPagerAdapter {
    private List<Tournament> tournaments = new ArrayList<>();
    private Context context;

    public PositionTabsPagerAdapter(FragmentManager fm, Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        return PositionFragment.newInstance(tournaments.get(position).getId());
    }
