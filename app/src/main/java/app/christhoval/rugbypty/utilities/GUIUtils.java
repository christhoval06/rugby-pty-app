...
import app.christhoval.rugbypty.interfaces.OnRevealAnimationListener;
...
public class GUIUtils {
    ...
    public static void animateRevealHide(final Context ctx, final View view, @ColorRes final int color,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            anim = android.view.ViewAnimationUtils.createCircularReveal(view, cx, cy, initialRadius, finalRadius);
        }
    ...
    public static void animateRevealShow(final Context ctx, final View view, final int startRadius, @ColorRes final int color, int x, int y, final OnRevealAnimationListener listener) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            anim = android.view.ViewAnimationUtils.createCircularReveal(view, x, y, startRadius, finalRadius);
        }
